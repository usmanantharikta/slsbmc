...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>TABLE OF ALL REGISTER CARD ON THE SYSTEM</h2>
...
<div class="x_content">
  ...
  This is table of all register card
  </p>
<a href="javascript:void(0)" onclick="reload_table()"class="btn btn-raised btn-primary">Reload Table</a>
  <table id="register-tag" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <thead>
      <tr>
        <th>No</th>
        <th>RFID</th>
...
<script>
var url="<?php echo site_url("admin/get_data_register_tag/")?>";  //url to get data new book from databases on table master book where status is 0 (new input)
var table_member;
var user_id_global=0;
//plot data to table using ajax
$(document).ready(function() {
table_member=$('#register-tag').DataTable( {
    "ajax":
    {
        "url": url,
        "type": "POST",
